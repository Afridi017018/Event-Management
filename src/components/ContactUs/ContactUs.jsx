            ...
            <div className="hero bg-custom-img">
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className='text-center py-10'>
                        ...
                        <form className='text-center my-5 text-black'>
                            <div>
                            ...
                            <div>
                                <textarea className='w-2/3 my-2 px-3 py-1 h-24 rounded-lg' placeholder='Enter Message' type="text" value={formData.message} onChange={handleChange} name="message" id="" />
                            </div>

                            <div>
                                <button onClick={handleContact} type='submit' className='bg-blue-500 hover:bg-blue-800 px-3 py-1 text-white font-medium rounded w-28 text-lg'>Submit</button>
                            </div>
                        </form>
                    </div>
